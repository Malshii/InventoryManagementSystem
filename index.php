    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="https://cdn-icons-png.flaticon.com/512/2897/2897763.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
		...
		<?php endif ?>
		<img src="homeImg.jpg" alt="welcome " style="width:100%">
        ...
        <footer>
            <div class="footer-area">
                <p>© 2022 Malshi Kulasinghe. All right reserved 2022.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
